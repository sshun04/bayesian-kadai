...
if __name__ == '__main__':
    # 回帰モデルからのデータ生成
    master_data = pd.DataFrame(california.data, columns=california.feature_names)
    y = california.target
    x1 = master_data['HouseAge']
    x2 = master_data['AveRooms']
    x3 = master_data['AveOccup']
    n = x1.shape[0]
